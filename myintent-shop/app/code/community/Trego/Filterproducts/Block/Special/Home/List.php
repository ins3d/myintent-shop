<?php
	...
	class Trego_Filterproducts_Block_Special_Home_List extends Trego_Filterproducts_Block_Special_List
	{
		...
		protected function _getProductCollection()
    	{
            ...
            $pagesize = $this->get_prod_count();
            if(Mage::getStoreConfig('filterproducts/special/max_product', $storeCode))
            {
                $pagesize = Mage::getStoreConfig('filterproducts/special/max_product');
            }
