...
class Trego_Trego_Block_Adminhtml_System_Config_Form_Field_Texture extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
		$html = $element->getElementHtml();
		$jsUrl = $this->getJsUrl('trego/jquery/jquery-1.7.2.min.js');
		$textureUrl = Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA) . Mage::helper('trego')->getTexturePath();
