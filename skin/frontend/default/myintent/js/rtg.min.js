/* Responsive Tile Gallery Version 2.0 - By Andrew Mead @ www.andrewjmead.com */ ! function (a) {
    a.fn.rtg = function (c) {
		
/* customization - disable scrolling 
		// remove scroll bar
		var html = jQuery('html'); // it would make more sense to apply this to body, but IE7 won't have that
		html.css('overflow', 'hidden');

		// disable keys: up/down/left/right arrows and page up/page down/home/end keyboard buttons
		window.addEventListener("keydown", function(e) {
			// space and arrow keys
			if([33, 34, 35, 36, 37, 38, 38, 40, ].indexOf(e.keyCode) > -1) {
				e.preventDefault();
			}
		}, false);
customization end */

        b.options = a.extend(!0, {}, b.defaults, c), b.el = a(this), b.el.find(".rtg-images").css({
            height: b.options.initialHeight
        }), b.loading.start(), a(window).load(function () {
            b.init()
        })
    };
    var b = {};
    b.switchCount = 0, b.defaults = {
        categories: !0,
        categoryOptions: {
            includeAll: !0,
            defaultCategory: !1,
	...
	b.init = function () {
        b.options.lightbox && (this.el.find(".rtg-images > li").attr("data-group", "off"), this.el.find(".rtg-images > li").each(function () {
            ...
            image: {
                ...
                titleSrc: function (a) {
                    return console.log("***** item.el.parent() *****"), console.log(a.el.parent()), a.el.attr("data-title")
                }
            }
        })*/), b.options.categories && b.categories.init(), b.captions.init(), b.categories.filterBy(b.categories.currentCategory || "All"), b.images.resize(), b.images.show(), b.utils.addTransition(b.el.find(".rtg-images img"));
        setTimeout(function(){

/* myintent customization:            
            if(a(window).width() > 1024){
                a('.tile-container').css('height', a(window).height()+'px');
                a('.rtg-images').css('height', a(window).height()+'px');
            } else if(a(window).width() >=768 && a(window).width()<=1024){
                a('.tile-container').css('height', (a(window).height()-190)+'px');
                a('.rtg-images').css('height', (a(window).height()-190)+'px');
            }
*/

            a('#tileCaption').html(a(".rtg-images > li:first").attr('data-caption')+'<div class="clear"></div>');
/* myintent cutomization:            
            a(".rtg-images > li:first").addClass('active');
*/
        },500);
...
/* myintent customization               
                var item_columns = 3;
                var container_width = (a(window).width()-235)*0.6;
                if(a(window).width()<=1024){
                    container_width = (a(window).width()-10)*0.7;
                }
                if(a(window).width()<=767){
                    item_columns = 3;
                    container_width = a(window).width();
                }
*/                
//  myintent customization begin:
                var item_columns;

				// checks if screen is in "portrait" or "landscape" mode
				if (jQuery(window).width() < jQuery(window).height())
				{
					item_columns = 3;
					jQuery("#myintent_homepage_container").addClass("full-width");
				}
				else{
					item_columns = 7;
					jQuery("#myintent_homepage_container").removeClass("full-width");
				}
				
                var container_width = a(window).width();
				
/* customization begin - reset height and position of #myintent_homepage_container upon window resizing */
				var item_width = container_width/item_columns
				var homepage_container_height = item_width * 2;
				jQuery("#myintent_homepage_container").css("height", homepage_container_height).css("top", item_width - 1);
/* customization end */

// debug:                
// a("#windowwidth").text(a(window).width());
// a("#containerwidth").text(container_width);
// a("#itemwidth").text(item_width);

//  myintent customization end

                var item_width = (container_width-item_columns)/item_columns;
                d.width !== c.width && (d = c, b.options.imageWidth = item_width, b.images.resize(), setTimeout(function(){
                    b.images.sort();
                    b.images.center();
/* myintent customization                    
                    if(a(window).width() > 1024){
                        ...
                        a('.tile-container').css('height', 'auto');
                    }
*/                    
                },700))
            };
        a(window).resize(function () {
            clearTimeout(c), c = setTimeout(e, 200)
        }), b.images.sort(), b.images.center(), -1 != navigator.appVersion.indexOf("MSIE 7.") && (b.el.find(".rtg-categories > li").css("display", "inline").find("a").css({
            display: "block",
            padding: "0px 0px"
        }), b.el.find(".rtg-images > li > div > p").css({
            background: "url(images/ieCaptionOpacity.png)",
            filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#00FFFFFF, endColorstr=#00FFFFFF)"
        })), -1 != navigator.appVersion.indexOf("MSIE 8.") && b.el.find(".rtg-images > li > div > p").css({
            background: "url(images/ieCaptionOpacity.png)",
            filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#00FFFFFF, endColorstr=#00FFFFFF)"
        })
    }, b.loading = {
        image: a("<img src='skin/frontend/default/trego/images/loading.gif'/>"),
        start: function () {
            this.image.css({
                position: "fixed",
                top: '50%',
    ...
    }, b.lightbox = {}, b.lightbox.setup = function () {}, b.categories = {}, b.categories.init = function () {
        var c = this.getCategoryArray(),
            d = this.generateMarkup(c);
        if (b.el.prepend(d), b.el.find(".rtg-categories a").on("click", function (c) {
            b.categories.filterBy(a(c.target).attr("category"))
        }), b.options.categoryOptions && b.options.categoryOptions.defaultCategory ? -1 !== c.indexOf(b.options.categoryOptions.defaultCategory) && b.categories.setCurrentCategory(b.options.categoryOptions.defaultCategory) : b.categories.setCurrentCategory("All"), b.options.categoryOptions.enableHashLinking) {
        ...
        return b.el.find(".rtg-images > li").each(function () {
        ...
        for (var c = "", d = 0; d < a.length; d++) c += "<li>", c += b.options.categoryOptions.enableHashLinking ? "<a href='#" + encodeURIComponent(a[d]) + "' category='" + a[d] + "'>" + a[d] + "</a></li>" : "<a  category='" + a[d] + "'>" + a[d] + "</a></li>";
        return "<ul class='rtg-categories'>" + c + "</ul>"
    }, b.categories.filterBy = function (c) {
        b.categories.setCurrentCategory(c), b.el.find(".rtg-images > li").each(function () {
            var b = a(this),
                d = b.attr("data-category"),
                e = [];
            d && (e = b.attr("data-category").split(",")), "All" === c || -1 !== a.inArray(c, e) ? (b.css({
                display: "block"
            }), b.attr("data-group", "on")) : (b.css({
                display: "none",
                left: "0"
            }), b.attr("data-group", "off"))
        }), a(".rtg-images > li").each(function(){a(this).append('<div class="overlay"></div>');
        a(this).click(function(e){
            a(".rtg-images > li").removeClass('active');
            a(this).addClass('active');
            a('#tileCaption').hide();
            a('#tileCaption_clone').html(a('#tileCaption').html());
            a('#tileCaption_clone').show();
            a('#tileCaption').html(a(this).attr('data-caption')+'<div class="clear"></div>');
            a('#tileCaption_clone').fadeOut();
            a('#tileCaption').fadeIn();
            a("html, body").animate({scrollTop: 0}, 600, "easeOutCubic");
        });}),/*a(".rtg-images").magnificPopup({
        ...
        }), */b.switchCount++, b.images.sort(), b.images.center()
    }, b.categories.setCurrentCategory = function (c) {
        b.el.find(".rtg-categories > li > a.rtg-current-category").toggleClass("rtg-current-category"), b.el.find(".rtg-categories > li > a").each(function () {
            c === a(this).html() && a(this).toggleClass("rtg-current-category")
        }), this.currentCategory = c
    }, b.images = {}, b.images.resize = function () {
        ...
        b.el.find(".rtg-images img").css("opacity", "0").css("visibility", "visible").each(function () {
            a(this).animate({
                opacity: "1"
            }, {
                duration: 100 + Math.floor(900 * Math.random()),
                complete: function () {
                    b.loading.stop()
                }
            })
        ...
        e = 0 === e ? 1 : e;
        //alert('b.el.width:'+b.el.width()+','+'d.imageWidth:'+d.imageWidth+','+'d.spacing:'+d.spacing);
        var f = [],
            g = 0;
        for (g; e > g; g += 1) f[g] = 0;
        var h, i = 0,
            j = 0;
        c.each(function () {
            "none" != a(this).parent().css("display") && (j++, h = f.min(), b.utils.transitions ? a(this).add(a(this).siblings("div")).css({
                top: f[h],
                left: h * (d.imageWidth + d.spacing)
            }) : a(this).add(a(this).siblings("div")).animate({
                top: f[h],
                left: h * (d.imageWidth + d.spacing)
            }, {
                duration: 500,
                queue: !1
            }), f[h] = f[h] + a(this).height() + d.spacing, f[h] > i && (i = f[h]))
        }), b.options.center && (e = e > j ? j : e), b.el.find(".rtg-images").css({
            height: i,
            width: e * (d.imageWidth + d.spacing) - d.spacing
        }, 400)
    }, b.images.center = function () {
        if (b.options.center) {
            var a = b.el.find(".rtg-images"),
                c = (b.el.width() - a.width()) / 2;
            c = 0 >= c ? 0 : c, a.animate({
                left: c
            }), b.el.find(".rtg-categories").animate({
                "margin-left": c
            })
        }
    }, b.captions = {}, b.captions.init = function () {
        b.el.find(".rtg-images img").each(function () {
            var b = a(this),
                c = b.find("a").first().attr("title"),
                d = a("<div></div>"),
                e = a("<p></p>");
            if (c && 0 !== c.length) {
                e.html(c).find("a").each(function () {
                    a(this).attr("rel", "")
                }), d.append(e), b.append(d);
                var f = a("<p>" + c + "</p>");
                f.find("a").each(function () {
                    a(this).replaceWith(a(this).html())
                }), f = f.html(), b.find("a").first().attr("title", f)
            }
        }), b.captions.events()
    }, b.captions.events = function () {
        var c = b.el.find(".rtg-images img");
        c.hover(function () {
            a(this).find("div").css("visibility", "visible")
        }, function () {
            a(this).find("div").css("visibility", "hidden")
        })
    }, b.utils = {}, b.utils.addTransition = function (c) {
        b.utils.transitions && c.each(function () {
            a(this).css({
    ...
    }, b.utils.removeTransition = function (c) {
        b.utils.transitions && c.each(function () {
            a(this).css({
    ...
    }, b.utils.transitions = function () {
        function a() {
            var a, b, c = document.createElement("div"),
                d = ["ms", "O", "Webkit", "Moz"];
            for (a in d)
                if (void 0 !== c.style[d[a] + "Transition"]) {
                    b = d[a];
                    break
                }
            return delete c, b
        ...
        var a = 0,
            b = 0;
        for (b; b < this.length; b += 1) this[b] < this[a] && (a = b);
        return a
    }
}(jQuery),
function (a) {
