    ...
    public function validate()
    {
        ...
        if(Mage::app()->getFrontController()->getRequest()->getModuleName() == 'onepagecheckout'){
            ...
            if ($password != $confirmation) {
                $errors[] = Mage::helper('customer')->__('Please make sure your passwords match.' . Mage::app()->getFrontController()->getRequest()->getModuleName());
            }
        }else{
        ...
        /* Matt core magento change based on bug in 1.9.1.0
        //$confirmation = $this->getPasswordConfirmation();
        if ($password != $confirmation) {
