<?php
class Trego_Trego_Block_Configurableswatches_Catalog_Media_Js_List extends Mage_ConfigurableSwatches_Block_Catalog_Media_Js_List {
    public function getProductImageFallbacks($keepFrame = null) {
		...
		$keepFrame = Mage::getStoreConfig("trego_settings/category/aspect_ratio",$code);
		$ratio_width = Mage::getStoreConfig("trego_settings/category/ratio_width",$code);
		$ratio_height = Mage::getStoreConfig("trego_settings/category/ratio_height",$code);
