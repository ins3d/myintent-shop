<?php 
class Trego_Trego_Model_Cssconfig_Generator extends Mage_Core_Model_Abstract{ 
    ...
    protected function generateStoreCss($type, $storeCode){
        ...
        $str1 = '_' . $storeCode;
        $str2 = $type . $str1 . '.css';
        $str3 = Mage::helper('trego/cssconfig')->getCssConfigDir() . $str2;
        ...
        try{ 
            ...
            $file->open(array( 'path' => Mage::helper('trego/cssconfig')->getCssConfigDir() )); 
            ...
            Mage::getSingleton('adminhtml/session')->addError(Mage::helper('trego')->__('Failed generating CSS file: %s in %s', $x12, Mage::helper('trego/cssconfig')->getCssConfigDir()). '<br/>Message: ' . $e->getMessage()); 
            Mage::logException($e);
        }
