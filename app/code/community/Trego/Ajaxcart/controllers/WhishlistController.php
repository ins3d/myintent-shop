<?php
class Trego_Ajaxcart_WhishlistController extends Mage_Core_Controller_Front_Action
{
	...
	public function compareAction(){
		...
		if ($productId = (int) $this->getRequest()->getParam('product')) {
			...
			if ($product->getId()/* && !$product->isSuper()*/) {
				...
				$sidebar_block->setTemplate('ajaxcart/catalog/product/compare/sidebar.phtml');
