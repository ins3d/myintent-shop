...
class MW_Storecreditpro_Block_Adminhtml_Member_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('save', 'label', Mage::helper('storecreditpro')->__('Save Member'));
    ...
    {   
    	...
    	if(isset($customer_id)){
    		...
    		return Mage::helper('storecreditpro')->__($this->htmlEscape($name));
    	}
