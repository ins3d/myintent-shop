<?php
class MW_Storecreditpro_Block_Adminhtml_Customer_Edit_Tab_Storecredit
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
        return Mage::helper('storecreditpro')->__('Credit');
    }
    ...
    protected function _prepareLayout()
    {
        ...
        $accordion->addItem('storecredit_history', array(
            ...
            'class'       => '',
            'ajax'        => true,
            'content_url' => $this->getUrl('storecreditpro/adminhtml_customer/history', array('_current' => true))
        ));
