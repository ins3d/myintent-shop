...
Checkout.prototype = {
    initialize: function(accordion, urls){
        ...
        this.steps = ['login', 'shipping', 'payment', 'review', 'confirm'];
    ...
    setMethod: function(){
        this.method = 'guest';
        $('checkout-info-step-shipping').hide();
...
Payment.prototype = {
    ...
    init : function () {
        this.beforeInit();
        var elements = Element.getElementsBySelector('checkout-payment-method-load','input');
        var method = null;
